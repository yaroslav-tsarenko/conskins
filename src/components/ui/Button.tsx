...
/**
 * ConSkins Button — graphite/volt:
 *   primary  = volt-lime filled, dark ink (main CTA — buy, sell, submit)
 *   secondary= volt outline               (secondary action — view, browse)
...
export function Button({
  ...
  const variants: Record<string, string> = {
    primary:
      "bg-[color:var(--color-primary)] text-[color:var(--color-primary-fg)] font-semibold border border-transparent hover:bg-[color:var(--color-primary-hover)] hover:shadow-[0_0_24px_var(--color-primary-glow)] active:translate-y-[1px]",
    secondary:
