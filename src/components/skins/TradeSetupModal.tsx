      ...
      <div className="glass relative w-full max-w-md rounded-2xl border border-[color:var(--color-border)] p-6">
        ...
        {state === "anon" && (
          <div className="text-center">
            ...
            <Link
              href={authHref}
              className="mt-5 flex w-full items-center justify-center gap-2 rounded-xl bg-[color:var(--color-primary)] px-5 py-3 text-sm font-bold text-[color:var(--color-primary-fg)] shadow-[var(--shadow-glow-volt)] hover:brightness-110"
            >
              Continue with Email
            </Link>
          </div>
        ...
        {state === "no-steam" && (
          <div className="text-center">
            ...
            <p className="mt-1 text-sm text-[color:var(--color-text-secondary)]">
              ...
              <span className="font-semibold text-[color:var(--color-text)]">{skinName}</span> — your ConSkins
