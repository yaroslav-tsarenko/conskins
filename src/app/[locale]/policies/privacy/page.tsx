...
export default function PrivacyPolicyPage() {
  return (
    <PolicyLayout title="Privacy Policy" lastUpdated="29 May 2026">
      <p>
        This Privacy Policy explains how CONDEO LTD, trading as ConSkins, collects, uses, stores, shares,
        and protects personal data when you visit www.conskins.com, create an account, place an order,
        contact us, use our services, or otherwise interact with us.
      </p>
      <p>The Website is operated by:</p>
      <ContactBlock />
      <p>
        In this Privacy Policy, &ldquo;ConSkins&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo; or
        &ldquo;our&rdquo; means CONDEO LTD. &ldquo;Customer&rdquo;, &ldquo;you&rdquo; or
      ...
      <p>
        ...
        Regulation, CONDEO LTD is the data controller of your personal data.
      </p>
      ...
      <p>3.1 The personal data we collect depends on how you interact with ConSkins.</p>
      ...
      <p>
        ...
        the relevant email or contacting us at info@conskins.com.
      </p>
      <p>
      ...
      <p>
        11.1 Because ConSkins sells internationally and uses third-party service providers, your personal
      ...
      <p>14.3 To exercise your rights, please contact us at info@conskins.com.</p>
      ...
      <p>
        ...
        info@conskins.com so we can try to resolve the matter.
      </p>
      <p>
      ...
      <p>
        ...
        info@conskins.com and we will take appropriate steps to review and delete the information where
        required.
      </p>
