...
export const metadata = { title: "Trade Delivery Policy — ConSkins" };
  ...
  return (
    <PolicyLayout title="Trade Delivery Policy" lastUpdated="29 May 2026">
      <p>
        ...
        www.conskins.com are delivered to your Steam inventory, the timeframes involved, and how we
      ...
      <p>
        ...
        means CONDEO LTD. &ldquo;Customer&rdquo;, &ldquo;you&rdquo; or &ldquo;your&rdquo; means the
      ...
      <p>2.1 To receive a skin, you must have a valid Steam account linked to your ConSkins account.</p>
      <p>
      ...
      <p>
        ...
        you must update it in your ConSkins account before purchasing.
      </p>
      ...
      <p>
        ...
        in your inventory until Steam releases it. This hold is imposed by Valve, not by ConSkins.
      </p>
      <p>
      ...
      <p>
        5.4 ConSkins is not responsible for delays caused by Steam trade holds, Steam Guard settings, or
      ...
      <p>
        ...
        delivery and, where delivery remains impossible, refund your ConSkins wallet balance in full.
      </p>
      ...
      <p>
        ...
        contact us at info@conskins.com.
      </p>
