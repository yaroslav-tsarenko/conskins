...
const CONTACT_INFO = [
  ...
  { icon: Phone, title: "Trade support", detail: brand.contact.email, sub: "Trades, deliveries & disputes" },
  { icon: MapPin, title: "Registered office", detail: brandAddressLine, sub: `${brand.company.legalName} · Company number ${brand.company.number}`, tooltip: `${brandAddressLine}\nCompany number ${brand.company.number}` },
