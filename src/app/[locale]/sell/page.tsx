...
const STEPS = [
  ...
  { icon: Wallet, title: "Get paid on sale", text: "Funds land in your ConSkins balance the moment a buyer completes the trade." },
];
  ...
  return (
    <div className="mx-auto w-full max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="mt-6 flex items-center gap-3 rounded-2xl border border-[color:var(--color-border)] bg-[color:var(--color-bg-secondary)] p-5 text-sm text-[color:var(--color-text-secondary)]">
        ...
        and seller protection. ConSkins never holds your items outside a live sale.
      </div>
    </div>
  );
}
